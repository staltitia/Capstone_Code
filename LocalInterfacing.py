...
#		return
	...
	if modeVal == "Photo":
		...
		#toSend.append( chr(0b00000001) )
		toSend = toSend + chr(0b00000001)
		toSend = toSend + chr(0b00000001)
	elif modeVal == "Slow 1":
		#toSend.append( chr(0b00000001) )
		#toSend.append( chr(0b00000010) )
		toSend = toSend + chr(0b00000001)
		toSend = toSend + chr(0b00000010)
	elif modeVal == "Slow 2":
		#toSend.append( chr(0b00000001) )
		#toSend.append( chr(0b00000100) )
		toSend = toSend + chr(0b00000001)
		toSend = toSend + chr(0b00000100)
	elif modeVal == "Fast":
		#toSend.append( chr(0b00000001) )
		#toSend.append( chr(0b00001000) )
		toSend = toSend + chr(0b00000001)
		toSend = toSend + chr(0b00001000)
	elif modeVal == "TV":
		#toSend.append( chr(0b00000001) )
		#toSend.append( chr(0b00010000) )
		toSend = toSend + chr(0b00000001)
		toSend = toSend + chr(0b00010000)
	...
	toSend = toSend +  chr(0b00000011) 
	toSend = toSend + chr( int(window.shiftXVar + 127) ) 
	toSend = toSend + chr(0b00000100) 
	toSend = toSend + chr( int(window.shiftYVar + 127) ) 
	toSend = toSend + chr(0b00000101) 
	toSend = toSend + chr( int(window.stigXVar) ) 
	toSend = toSend + chr(0b00000110) 
	toSend = toSend + chr( int(window.stigYVar) ) 
	toSend = toSend + chr(0b00000111) 
	toSend = toSend + chr( int(window.condVar) ) 
	toSend = toSend + chr(0b00001000) 
	toSend = toSend + chr( int(window.objVar) ) 
	toSend = toSend + chr(0b00001001) 
	toSend = toSend + chr( int(window.filaVar) ) 
	toSend = toSend + chr(0b00001010) 
	toSend = toSend + chr( int(window.magVar) ) 
...
#	sys.stdout.write(''.join(toSend) )
	for i in toSend:
		sys.stdout.write( str(bin(int(binascii.hexlify(i), 16))) + '\n' )
